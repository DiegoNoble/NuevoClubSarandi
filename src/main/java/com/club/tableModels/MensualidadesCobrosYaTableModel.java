 ...
 * @author Diego Noble
 */
public class MensualidadesCobrosYaTableModel extends AbstractTableModel {

    //nome da coluna da table
    private final String[] colunas = new String[]{" ", "Socio", "Recibo", "Talón CobrosYa", "Enviado", "Situación", "Vencimiento", "Pago", "Medio de Pago", "Valor"};
    //lista para a manipulacao do objeto
    private List<Mensualidades> listMensualidades;

    public MensualidadesCobrosYaTableModel() {
        listMensualidades = new LinkedList<Mensualidades>();
    }

    public MensualidadesCobrosYaTableModel(List<Mensualidades> listMensualidades) {
