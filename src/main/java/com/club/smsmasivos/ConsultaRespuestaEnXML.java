...
public class ConsultaRespuestaEnXML {

    ParametrosDAO parametrosDAO;

    public String ConsultaXML(String nro, String mensaje) {
...
//de la URL suministrada por Altiria al dar de alta el servicio
        post = new PostMethod("http://servicio.smsmasivos.com.ar/ws/SMSMasivosAPI.asmx?WSDL");
...
//Se procesa la respuesta capturada en la cadena ‘‘response’’
    ...
    public static void main(String[] args) {
        ConsultaRespuestaEnXML sMSIndividual = new ConsultaRespuestaEnXML();
        sMSIndividual.ConsultaXML("091390000", "otra prueba ID Interno");
    }
}
