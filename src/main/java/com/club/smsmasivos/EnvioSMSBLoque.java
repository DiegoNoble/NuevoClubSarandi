...
public class EnvioSMSBLoque {

    ParametrosDAO parametrosDAO;

    public String EnvioSMSIndividual(String nrosSeparadosPorComa, String mensaje) {
...
//de la URL suministrada por Altiria al dar de alta el servicio
        post = new PostMethod("http://servicio.smsmasivos.com.ar/enviar_sms_bloque.asp?api=1");
...
//usuario en el sistema.
        ...
        parametersList[2] = new NameValuePair("SEPARADORCAMPOS", ",");
        parametersList[2] = new NameValuePair("BLOQUE", nrosSeparadosPorComa);
...
//Se procesa la respuesta capturada en la cadena ‘‘response’’
    ...
    public static void main(String[] args) {
        EnvioSMSBLoque bLoque = new EnvioSMSBLoque();
        bLoque.EnvioSMSIndividual("091390000    094897912   091056948   098032339   099953561", "Quien va hacer el café??!!");
