...
public class ConsultaSMSEnviados {

    ParametrosDAO parametrosDAO;

    public void ConsultaSMSEnviados() {
...
//de la URL suministrada por Altiria al dar de alta el servicio
        post = new PostMethod("http://servicio.smsmasivos.com.ar/obtener_envios.asp?api=1");
...
//Se procesa la respuesta capturada en la cadena ‘‘response’’
    ...
    public static void main(String[] args) {
        ConsultaSMSEnviados c = new ConsultaSMSEnviados();
        c.ConsultaSMSEnviados();
    }
}
