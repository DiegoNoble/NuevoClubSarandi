...
public class ConsultaVencimiento {

     ParametrosDAO parametrosDAO;
     
    public void ConsultaVencimiento() {
...
//de la URL suministrada por Altiria al dar de alta el servicio
        post = new PostMethod("http://servicio.smsmasivos.com.ar/obtener_vencimiento_paquete.asp?api=1");
...
//Se procesa la respuesta capturada en la cadena ‘‘response’’
    ...
    public static void main(String[] args) {
        ConsultaVencimiento c = new ConsultaVencimiento();
        c.ConsultaVencimiento();
